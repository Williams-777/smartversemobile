  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CalculationCubit, CalculationState>(
      builder: (context, state) {
        ...
        final applianceNames = result.breakdown.map((b) => b.applianceName).take(3).join(", ");
        ...
        return Scaffold(
          ...
          body: SafeArea(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  CalculatedContainer(kva: rec.inverterKva.toStringAsFixed(0)),
                  ...
                  SizedBox(height: 16.h),
                  Padding(padding: EdgeInsets.symmetric(horizontal: 15.5.w), child: LoadProfileContainer()),
                  SizedBox(height: 16.h),
                  Padding(
